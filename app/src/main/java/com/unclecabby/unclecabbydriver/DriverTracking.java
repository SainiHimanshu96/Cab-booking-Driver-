...
import com.unclecabby.unclecabbydriver.Helper.DirectionJSONParser;
...
public class DriverTracking extends FragmentActivity implements OnMapReadyCallback ,
    ...
    private void calculateCashFee(final Location pickupLocation, Location mLastLocation) {
        ...
        try
        {
            requestApi = "https://maps.googleapis.com/maps/api/directions/json?"+
                    ...
                    "origin="+pickupLocation.getLatitude()+","+pickupLocation.getLatitude()+"&"+
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //geo fencing with radius is 50m
    ...
    private void sendArrivedNotification(String customerId) {
        final Token token = new Token(customerId);
